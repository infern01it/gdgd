...
class MainFilter extends Component {
  ...
  render() {
    const {msCity, msConcept, pageMap, pageHome, pagePlace, filterProps, display, visible, toggleFilter, isMobile } = this.props;
...
const mapStateToProps = state => ({
  msConcept: getConceptInFilter(state.concept, state.arrays),
  msCity: getCityInFilter(state.city),
