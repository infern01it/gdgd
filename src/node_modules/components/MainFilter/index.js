...
import {getConceptInFilter, getCityInFilter, getFilteringProps} from 'selectors';
...
class MainFilter extends Component {
  ...
  render() {
    const {msCity, msConcept, pageMap, pageHome, pagePlace, filterProps} = this.props;
        ...
        <div className={filterContainerClass}>
          <div className={filterPriceClass}>
            <FilterField
              ...
              onChangedMin={this.handleFieldPriceChangedMin.bind(this)}
              onChangedMax={this.handleFieldPriceChangedMax.bind(this)}
            />
          </div>
          <div className={filterAreaClass}>
            <FilterField
              ...
              onChangedMin={this.handleFieldAreaChangedMin.bind(this)}
              onChangedMax={this.handleFieldAreaChangedMax.bind(this)}
            />
          </div>
          ...
          <div className={filterButtonClass}>
            <div className="card-filter-field">
              ...
              {
                pageMap && <div className="card-filter-field__inputs">
                  <button
                    className="btn btn_color_ac card-filter-field__button"
...
const mapStateToProps = state => ({
  ...
  filterProps: getFilteringProps(state)
});
