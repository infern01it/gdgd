...
import {updateFilterProps, clearFilterProps} from 'actions';
...
class MainFilter extends Component {
  ...
  componentWillMount() {
    ...
    // if(typeof filter !== 'undefined' && Object.keys(filter).length != 0 && filter.city_id.length !== 0) {
    //   updateFilterProps({ city_id: filter.city_id });
    //   this.updateFilter();
    // }
    // if(typeof filter !== 'undefined' && Object.keys(filter).length != 0 && filter.city_id.length === 0) {
    //   updateFilterProps({ city_id: [] });
    //   this.updateFilter();
    // }
  ...
  render() {
    const {msCity, msConcept, pageMap, pageHome, pagePlace, filterProps, display, visible, toggleFilter, updateFilter, isMobile } = this.props;
        ...
        <div className={filterContainerClass}>
          ...
          <div className={filterButtonClass}>
            <div className="card-filter-field">
              ...
              {
                ((pageMap || pagePlace) && !isMobile) && <div className="card-filter-field__inputs">
                  <button
                    className="btn btn_color_ac card-filter-field__button"
