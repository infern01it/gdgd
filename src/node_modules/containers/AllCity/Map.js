...
import { getCoords, filteringMap, getArrayFromCoords } from 'selectors';
...
class Map extends Component {
  ...
  componentWillMount() {
    const { arrays, city, filterProps, openViewArray } = this.props;
    ...
    yMaps.ready(() => {
      ...
      result = points.search(el => filteringMap(el, city, filterProps));
      ...
      points.addEvents('click', function(e) {
        ...
        openViewArray(getArrayFromCoords(arrays, coords).id);
      });
  ...
  componentWillUpdate(nextProps) {
    const { city, filterProps, centerMap } = nextProps;
